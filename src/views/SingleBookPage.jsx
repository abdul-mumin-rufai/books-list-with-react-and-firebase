...
function SingleBookPage() {
  ...
  function handleToggleRead(payload) {
    dispatch(toggleRead({ id: payload.id, isRead: payload.isRead })); // for the database level
    setBook({ ...book, isRead: !payload.isRead }); // only the isRead // for the local state re render.
  }

  // single book page need the book from the database.
